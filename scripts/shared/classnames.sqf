...
// If overwrite is true, replace all vanilla Elite vehicles with the ones in the extension. If false, only vanilla vehicles remain.
...
if (elite_vehicles_overwrite) then { elite_vehicles = elite_vehicles_extension };
